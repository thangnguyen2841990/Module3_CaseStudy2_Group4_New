                ...
                <div class="product">
                        ...
                        <table class="table table-sm">
                            ...
                            <c:forEach items="${requestScope['parts']}" var="part">
                                <tr>
                                    <td>${part.getEpisode()}</td>
                                    <td>${part.getName()}</td>
                                    <td>
                                        <a href="/StoryServlet?action=read&storyId=${part.getStoryID()}&id=${part.getId()}&categoryId=${part.getCategoryId()}">
                                            <button type="button" class="btn btn-outline-success">Đọc</button>
                                        </a>
                                        <a href="/StoryServlet?action=buy&id=${part.getId()}">
                                            <button type="button" class="btn btn-outline-primary">Mua</button>
                                        </a>
