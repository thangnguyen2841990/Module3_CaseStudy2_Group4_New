        ...
        <section class="content">
            <div class="container-fluid">
                <div class="container">
                    ...
                    <form action="stories?action=delete&id=${story.id}" method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="dateSubmitted" class="form-label">Ngày Đăng:</label>
                            <input type="text" class="form-control" id="dateSubmitted" name="dateSubmitted"
                                   value="${story.dateSubmited}" disabled>
                        </div>
                        <div class="mb-3">
                            <label for="img" class="form-label">Ảnh:</label>
                            <input type="text" class="form-control" id="img" name="description" value="${story.img}"
                                   disabled>
                        </div>
                        <div class="mb-3">
                            <div class="mb-3">
